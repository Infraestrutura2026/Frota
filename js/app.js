  ...
  function gerarRelatorio() {
    ...
    switch (reportAtual) {
      ...
      case 'cnh': {
        ...
        hoje.setHours(0,0,0,0);
        rows = drivers.map(d => {
          const val = d.cnh_vencimento ? new Date(d.cnh_vencimento + 'T00:00:00') : null;
          ...
          const valStr = val ? val.toLocaleDateString('pt-BR') : '-';
          return [d.nome, d.cnh, valStr, dias, status];
        }).sort((a, b) => a[3] - b[3]);
        break;
      }
      case 'emManutencao': {
